...
local c = require('quasar.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "Constructor", { fg = c.green, bg = 'NONE' })
  hl(0, "Keyword", { fg = c.purple, bg = 'NONE' })
  hl(0, "Conditional", { fg = c.darkcyan, bg = 'NONE' })
  ...
  hl(0, "TSPunctBracket", { link = 'blue' })
  hl(0, "TSPunctSpecial", { link = 'magenta' })
  hl(0, "TSTag", { link = 'Tag' })
  ...
  hl(0, "NvimTreeNormal", { fg = c.fg, bg = c.altwin })
  hl(0, "NvimTreeWinseparator", { fg = c.dark_gray, bg = 'NONE' })
